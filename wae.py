    ...
    def train(self):
        ...
        if self.opts['optimizer'] == 'adam':
            ...
            while it < total_num_iterations:
                ...
                if self.opts['loss_reconstruction'] in ['L2_squared+adversarial', 'L2_squared+adversarial+l2_filter', 'L2_squared+multilayer_conv_adv', 'L2_squared+adversarial+l2_norm', 'patch_moments']:
                    self.sess.run(
