...
celebA_mini_opts['make_pictures_every'] = 2
celebA_mini_opts['save_every'] = 2
...
celebA_opts['make_pictures_every'] = 2
celebA_opts['save_every'] = 2
celebA_opts['plot_axis_walks'] = False
#celebA_opts['axis_walk_range'] = 1
celebA_opts['plot_losses'] =  False
celebA_opts['print_log_information'] = True
celebA_opts['batch_size'] = 100
celebA_opts["encoder_architecture"] = 'small_convolutional_celebA'
celebA_opts["decoder_architecture"] = 'small_convolutional_celebA'
celebA_opts['z_mean_activation'] = None
celebA_opts['encoder_distribution'] = 'gaussian'
celebA_opts['logvar-clipping'] = [-20,5]
celebA_opts['z_prior'] = 'gaussian'
celebA_opts['loss_reconstruction'] = 'bernoulli'
celebA_opts['loss_regulariser'] = 'WAE_MMD'
celebA_opts['lambda_imq'] = 400.0
coeffs = [0.001, 0.005, 0.01, 0.05, 0.1, 0.2, 0.5, 0.8, 1.0, 2.0]
celebA_opts['IMQ_length_params'] = [c*celebA_opts['z_dim'] for c in coeffs]
celebA_opts['z_logvar_regularisation'] = "L1"
celebA_opts['lambda_logvar_regularisation'] = 0.1
celebA_opts['optimizer'] = 'adam'
celebA_opts['learning_rate_schedule'] = [(1e-4, 40000), (1e-5, 80001)]
